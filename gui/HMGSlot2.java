...
public class HMGSlot2 extends Slot
{
	
	private int id = 0;
	
    public HMGSlot2(IInventory p_i1824_1_, int p_i1824_2_, int p_i1824_3_, int p_i1824_4_)
    {
    ...
    public boolean isItemValid(ItemStack stack)
    {
    	...
    	if(id == 0) {
    		idd = (!stack.isEmpty() && stack.getItem() == Items.EMERALD);
   		 }
		if (id == 1) {
