...
public class HMGSlot2_M extends Slot
{
	
	private int id = 0;
	
    public HMGSlot2_M(IInventory p_i1824_1_, int p_i1824_2_, int p_i1824_3_, int p_i1824_4_)
    {
    ...
    public boolean isItemValid(ItemStack stack)
    {
		...
		if (id == 1) {
			idd = (!stack.isEmpty() && stack.getItem() == Items.GUNPOWDER);
		}
		if (id == 2) {
