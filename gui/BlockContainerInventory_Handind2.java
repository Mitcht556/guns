...
public class BlockContainerInventory_Handind2 extends Container
{
    ...
    public BlockContainerInventory_Handind2(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 35));
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 20, 53));
        this.addSlotToContainer(new Slot(furnaceInventory, 2, 92, 17));
