...
public class HMGMessageKeyPressed2 implements IMessage {
    ...
    public HMGMessageKeyPressed2(){}
 
    public HMGMessageKeyPressed2(int i) {
        this.key = i;
    }
    
    public HMGMessageKeyPressed2(int i, int j, boolean b) {
        this.key = i;
        this.count = j;
    }
    
    public HMGMessageKeyPressed2(int i, int entity) {
        this.key = i;
        this.fre = entity;
    }
    
    public HMGMessageKeyPressed2(Entity i) {
        this.keyentity = i;
    }
 
    public HMGMessageKeyPressed2(int i, double posx, double posy, double posz, double posx1, double posy1, double posz1, 
    ...
    public HMGMessageKeyPressed2(int i, double posx, double posy, double posz) {
    	this.key = i;
        this.posx = posx;
        this.posy = posy;
        this.posz = posz;
